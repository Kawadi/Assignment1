...
class CurriculumsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curriculum" do
    assert_difference('Curriculum.count') do
      post curriculums_url, params: { curriculum: { chapter: @curriculum.chapter, date: @curriculum.date } }
    end
  ...
  test "should update curriculum" do
    patch curriculum_url(@curriculum), params: { curriculum: { chapter: @curriculum.chapter, date: @curriculum.date } }
